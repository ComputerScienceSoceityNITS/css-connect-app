...
List<String> candidateType = ["Fresher", "Experienced"];
String stateHint = "E.g. Maharashtra, Karnataka,etc. or Type None";
String skillsHint = 'E.g. OT, Nursing, Radiology, etc.';
